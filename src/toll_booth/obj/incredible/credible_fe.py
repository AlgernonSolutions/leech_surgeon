...
_base_stem = 'https://www.cbh2.crediblebh.com'
_url_stems = {
    ...
    def retrieve(cls, id_source, session=None, username=None, password=None, domain_name=None):
        ...
        while attempts < 3:
            try:
                ...
                api_url = "https://login-api.cbh2.crediblebh.com/api/Authenticate/CheckLogin"
                index_url = "https://ww7.cbh2.crediblebh.com/index.aspx"
                first_payload = {'UserName': username,
                                 'Password': password,
                                 'DomainName': domain_name}
                headers = {'DomainName': domain_name, 'origin': 'https://login.cbh2.crediblebh.com'}
                post = session.post(api_url, json=first_payload, headers=headers, verify=False)
                ...
                second_post = session.post(index_url, data=second_payload, cookies=jar, verify=False)
                ...
                credible_value = cookie_values['.cbh2.crediblebh.com']['/']['cbh'].value
